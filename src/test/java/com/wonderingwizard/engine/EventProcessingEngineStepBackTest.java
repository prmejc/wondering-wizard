...
class EventProcessingEngineStepBackTest {
    ...
    class StepBackWithWorkQueueProcessor {
        ...
        void stepBackRevertsScheduleAbortion() {
            // Create schedule
            engine.processEvent(new WorkQueueMessage("queue1", WorkQueueStatus.ACTIVE, 0, null));

            // Abort schedule
            engine.processEvent(new WorkQueueMessage("queue1", WorkQueueStatus.INACTIVE, 0, null));
    ...
    class StepBackWithMultipleProcessors {
        ...
        void stepBackRevertsAllProcessors() {
            ...
            effects = engine.processEvent(new WorkQueueMessage("queue1", WorkQueueStatus.ACTIVE, 0, null));
