...
| 4 | `apmt.terminaloperations.joboperation.topic.confidential.dedicated.v1`                 | JobOperation |     Yes      |     Yes      |
| 5 | `apmt.terminaloperations.chetargetposition.topic.confidential.dedicated.v1`            | CheTargetPositionConfirmation |     Yes      |     Yes      |
| 6 | `apmt.terminaloperations.assetevent.rubbertyredgantry.topic.confidential.dedicated.v1` | AssetEvent (RTG) |     Yes     |     Yes      |
| 7 | `apmt.terminaloperations.assetevent.quaycrane.topic.confidential.dedicated.v1`         | AssetEvent (QC) |     Yes     |     Yes      |
| 8 | `apmt.terminaloperations.assetevent.emptyhandler.topic.confidential.dedicated.v1`      | AssetEvent (EH) |     Yes     |     No      |
| 9 | `apmt.quaysideoperations.quaycraneflowposition.topic.internal.any.v2`                  | QuayCraneMapping |     Yes     |     Yes      |
...
|---|-------|-------------|----------|:-----------:|:-----------:|
| 0 | `apmt.terminaloperations.equipmentinstruction.rubbertyredgantry.topic.confidential.dedicated.v1` | EquipmentInstruction | RTG | Yes |     Yes     |
| 1 | `apmt.terminaloperations.equipmentinstruction.terminaltruck.topic.confidential.dedicated.v1` | EquipmentInstruction | TT | Yes |     Yes      |
| 2 | `apmt.terminaloperations.equipmentinstruction.quaycrane.topic.confidential.dedicated.v1` | EquipmentInstruction | QC | Yes |     Yes      |
